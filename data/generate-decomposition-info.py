...
print("#ifndef UNICODE_DECOMPOSITION_HPP_INCLUDED")
print("#define UNICODE_DECOMPOSITION_HPP_INCLUDED")
print("")
...
print("};")
print("")
print("static uint32_t const* unicode_decompose(uint32_t codePoint, bool compatible, uint8_t* len) {")
