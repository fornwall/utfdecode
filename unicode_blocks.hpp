#ifndef UNICODE_CODE_BLOCKS_HPP_INCLUDED
#define UNICODE_CODE_BLOCKS_HPP_INCLUDED

 // NOTE: File generated by massage_unicode_blocks.py - do not edit

#include <cstdint>

struct unicode_block_t {
    uint32_t start;
    uint32_t end;
    char const* name;
};

static unicode_block_t unicode_blocks[] = {
