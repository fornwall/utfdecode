...
void encode_codepoint(uint32_t codepoint, program_options_t &program,
  ...
  if (program.output_format == output_format_t::DESCRIPTION_DECODING ||
    ...
    case 0:
      ...
      break;
    case 1:
      printf(" (Start of Header ^A)");
      break;
    case 2:
      printf(" (Start of Text ^B)");
      break;
    case 3:
      printf(" (End of Text	^C)");
      break;
    case 4:
    ...
    case 5:
      ...
      break;
    case 6:
      printf(" (Acknowledgement ^F)");
      break;
    case 7:
      printf(" (Bell ^G)");
      break;
    case 8:
      printf(" (Backspace ^H \\b)");
      break;
    case 9:
      printf(" (Horizontal tab ^I \\t)");
      break;
    case 10:
      printf(" (Line feed (^J, \\n)");
      break;
    case 11:
      printf(" (Vertical tab ^K \\v)");
      break;
    case 12:
      printf(" (Form feed ^L \\f)");
      break;
    case 13:
      printf(" (Carriage return (^M, \\r)");
      break;
    case 14:
      printf(" (Start of Text ^N)");
      break;
    case 15:
      printf(" (Shift In ^O	)");
      break;
    case 16:
      ...
      break;
    case 17:
      printf(" (Device Control 1 ^Q)");
      break;
    case 18:
      printf(" (Device Control 2 ^R)");
      break;
    case 19:
      printf(" (Device Control 3 ^S)");
      break;
    case 20:
      printf(" (Device Control 4 ^T)");
      break;
    case 21:
      printf(" (Negative Acknowledgement ^U)");
      break;
    case 22:
      printf(" (Synchronous idle ^V)");
      break;
    case 23:
      printf(" (End of Transmission Block ^W)");
      break;
    case 24:
      printf(" (Cancel ^X)");
      break;
    case 25:
      printf(" (End of Medium ^Y)");
      break;
    case 26:
      printf(" (Substitute ^Z)");
      break;
