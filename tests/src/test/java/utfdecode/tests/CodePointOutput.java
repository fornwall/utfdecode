...
class CodePointOutput {
    ...
    @Test void surrogates() {
        ...
        nameFromJava = Character.getName(0xDFFF);
        Assertions.assertEquals("LOW SURROGATES DFFF", nameFromJava);
    }
    ...
    @Test void privateUse() {
        ...
        Assertions.assertEquals("\uE000 = U+E000 PRIVATE USE E000\n", nameFromUtfDecode);
        ...
        Assertions.assertEquals("\uE001 = U+E001 PRIVATE USE E001\n", nameFromUtfDecode);
    }
